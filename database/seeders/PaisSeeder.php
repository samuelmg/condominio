...
{
    private string $paisesJson = '{"paises": [
    ...
    private string $jsonMx = '{"paises": [{"id":484,"alpha2":"mx","alpha3":"mex","name":"México"}]}';
    ...
    public function run(): void
    {
        array_search(config('app.env'), ['local', 'testing']) !== false
            ? $dataPaises = $this->jsonMx
            : $dataPaises = $this->paisesJson;

        foreach (json_decode($dataPaises)->paises as $pais) {
